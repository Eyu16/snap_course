      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg max-w-sm w-full">
        ...
        <div className="my-4 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg">
          ...
          <ol className="list-decimal list-inside space-y-2 pl-2">
            ...
            <li>
              Search for the appropriate <code>/refund</code> command
            </li>
            <li>Follow the instructions to get a refund</li>
          </ol>
          <p className="mt-3 text-sm italic">
            The bot has access to your complete purchase history with the actual
            transaction IDs required for processing refunds.
          </p>
        </div>
